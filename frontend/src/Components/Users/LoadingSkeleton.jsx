...
export default function LoadingSkeleton() {
  return (
    <div className='flex gap-2  max-w-2xl m-10 bg-gray-100 rounded'>
      <div className='w-32 h-32 flex items-center justify-center '>
        <img
          className={'animate-pulse w-10 rounded-t-lg opacity-75'}
          src={require('./no-image-icon-23485.png').default}
          alt={'Loading Skeleton Img'}
        />
      </div>
      <div className='flex flex-col relative gap-2 p-2 animate-pulse'>
        <div className='w-28 h-4 rounded bg-gray-400'></div>
        <div className='w-24 h-3 rounded bg-gray-300'></div>
        <div className='w-40 h-4 rounded bg-gray-400'></div>
        <div className='absolute bottom-2 w-24 h-3 rounded bg-gray-300'></div>
      </div>
      <div className='ml-auto my-auto w-20 h-6 bg-gray-400 rounded animate-pulse'></div>
    </div>
  );
}
