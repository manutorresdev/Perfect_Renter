...
export default function Property({ property }) {
  ...
  return (
    <article className='cont-vivienda overflow-hidden bg-white sm:w-auto min-w-min my-5 shadow-2xl text-gray-400 hover:text-gray-900 duration-200'>
      <div className='slider w-full sm:w-auto relative '>
        <button
          onClick={right}
