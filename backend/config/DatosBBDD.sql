...
INSERT INTO perfect_renter.properties(idUser, city, province, address, zipCode, `number`, `type`, stair, flat, gate, mts, rooms, garage, terrace, toilets, energyCertificate, availabilityDate, price, state, modifiedAt, createdAt, description)
VALUES(15, 'Cadiz', 'Cadiz', 'Calle Murillo', '11010', 20, 'dúplex', '6', 8, '2', 80, 3, 0, 0, 1, 0, CURRENT_DATE(), 65.00, 'disponible', NULL, CURRENT_TIMESTAMP(),"Espectacular duplex en finca de reciente construcción (año 2021), primeras calidades, situado en una de las mejores zonas de la ciudad como es el barrio de La Laguna. Proximidad al Hospital Universitario Puerta del Mar, multitud de comercios y supermercados y magníficas conexiones con las principales estaciones de transporte urbano e interurbano.
